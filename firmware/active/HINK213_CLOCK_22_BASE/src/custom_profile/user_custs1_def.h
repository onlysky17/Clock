...
#define DEF_SVC2_HINK_WRITE_CHAR_LEN     20
#define DEF_SVC2_HINK_NOTIFY_CHAR_LEN    20
...
enum
{
    ...
    SVC2_IDX_SVC,
    SVC2_IDX_HINK_WRITE_CHAR,
    SVC2_IDX_HINK_WRITE_VAL,
    SVC2_IDX_HINK_NOTIFY_CHAR,
    SVC2_IDX_HINK_NOTIFY_VAL,
    SVC2_IDX_HINK_NOTIFY_NTF_CFG,
