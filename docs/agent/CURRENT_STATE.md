...
- Build evidence from the D6C company physical package:
  ...
  - Code `40804`, RO-data `3592`, RW-data `552`, ZI-data `22928`.
  - Raw BIN `46084` bytes.
...
- This is a web status rendering/state issue and did not block the D6C firmware merge or physical PASS.
...
- D6B-FIX1 must preserve D6C firmware behavior, D3E scheduler/persistence, geometry, protocol, and SPI sector unless explicitly scoped otherwise.
